...
const projects = [
  {
    name: 'Ninth Street Jerky',
    description: 'Selling artisinal beef jerky across Philadelphia while collaborating with some awesome Amish families',
    link: { href: '#', label: '' },
...
export const metadata: Metadata = {
  title: 'Projects',
  description: 'Some of my cooler projects.',
}

export default function Projects() {
  return (
    <SimpleLayout
      title="Some of My Cooler Projects."
      intro="A handful of the projects that I'm proud to have worked on."
    >
      <ul
        role="list"
